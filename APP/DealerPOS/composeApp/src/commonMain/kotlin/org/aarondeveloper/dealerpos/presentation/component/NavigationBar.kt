...
@Preview
@Composable
fun FloatingNavigationBarPreview() {
    val items = listOf(
        NavItem("Favoritos", Res.drawable.btn_2) { /* Acción para Favoritos */ },
        NavItem("Herramientas", Res.drawable.more) { /* Acción para Herramientas */ },
        NavItem("Inicio", Res.drawable.btn_1) { /* Acción para Inicio */ },
        NavItem("Carrito", Res.drawable.btn_3) { /* Acción para Carrito */ },
        NavItem("Perfil", Res.drawable.btn_4) { /* Acción para Perfil */ }
    )
